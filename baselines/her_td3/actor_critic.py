...
from baselines.her_td3.util import store_args, nn
    ...
    def __init__(self, inputs_tf, dimo, dimg, dimu, max_u, o_stats, g_stats, hidden, layers,
        ...
        Args:
            ...
            max_u (float): the maximum magnitude of actions; action outputs will be scaled
                accordingly
            o_stats (baselines.her_td3.Normalizer): normalizer for observations
            g_stats (baselines.her_td3.Normalizer): normalizer for goals

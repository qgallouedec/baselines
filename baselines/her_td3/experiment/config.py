...
from baselines.her_td3.td3 import TD3
from baselines.her_td3.her_td3_sampler import make_sample_her_td3_transitions
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'baselines.her_td3.actor_critic:ActorCritic',
...
def configure_her_td3(params):
    ...
    for name in ['replay_strategy', 'replay_k']:
        her_td3_params[name] = params[name]
        params['_' + name] = her_td3_params[name]
        del params[name]
    sample_her_td3_transitions = make_sample_her_td3_transitions(**her_td3_params)

    return sample_her_td3_transitions
...
def configure_td3(dims, params, reuse=False, use_mpi=True, clip_return=True):
    sample_her_td3_transitions = configure_her_td3(params)
